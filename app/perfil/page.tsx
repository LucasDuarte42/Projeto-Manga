...
function CollectionRow({ manga, showMissingVolumes = false }: { manga: { id: string; name: string; coverUrl: string | null; status: string; isInWishlist: boolean; collectionType: string; ownedVolumes: number[]; totalVolumes: number | null; updatedAt: Date }; showMissingVolumes?: boolean }) {
