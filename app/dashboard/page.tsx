    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <main className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-10 flex items-center gap-6">
          <div>
            <p className="text-gray-400 text-sm mb-1">Média de Notas</p>
            <p className="text-4xl font-bold text-purple-400">{media}</p>
          </div>
          <div className="text-gray-500 text-sm">
            Baseado em {notas.length} mangá{notas.length !== 1 ? 's' : ''} com nota
          </div>
        </div>

        {total === 0 && (
          <div className="text-center py-16 border border-dashed border-gray-700 rounded-xl">
            <p className="text-gray-400 text-lg mb-4">Sua coleção está vazia</p>
